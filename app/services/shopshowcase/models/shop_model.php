		...
		if($products)
        {
	        ...
	        if(!$getProductOptions)
	        {
	        	...
	        	if($mainOptions = $this->db->get('array'))
	        	{
	        		...
	        		if($_SESSION['language'])
	        			$where['language'] = $_SESSION['language'];
			        $options = $this->db->select($this->table('_product_options'). ' as po', 'option, product, value, language', array('product' => $products_ids, 'option' => $ids))
		            ...
		            if($options)
		            	foreach ($options as $opt) {
			            	...
			            	{
			            		if($_SESSION['language']){
			            			if($opt->language == $_SESSION['language'])
