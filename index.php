...
define('SITE_EMAIL', 'info@caravan'); // Від даної пошти сайт відправляє листи
define('SYS_PASSWORD', '76c5c1e76029'); // Сіль для кешування критичних даних (паролі)
...
$_SESSION['all_languages'] = array('uk', 'ru'); // Список всіх  мов в масиві, перша мова - мова по замовчуванню
